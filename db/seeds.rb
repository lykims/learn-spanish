...
words = Word.create([
        ...
        #
        {english: '1', spanish: 'uno', category_id:numbers_category.id},
        {english: '2', spanish: 'dos', category_id:numbers_category.id},
        {english: '3', spanish: 'tres', category_id:numbers_category.id},
        {english: '4', spanish: 'cuatro', category_id:numbers_category.id},
        {english: '5', spanish: 'cinco', category_id:numbers_category.id},
        {english: '6', spanish: 'seis', category_id:numbers_category.id},
        {english: '7', spanish: 'siete', category_id:numbers_category.id},
        {english: '8', spanish: 'ocho', category_id:numbers_category.id},
        {english: '9', spanish: 'nueve', category_id:numbers_category.id},
        {english: '10', spanish: 'diez', category_id:numbers_category.id},
        {english: '11', spanish: 'once', category_id:numbers_category.id},
        {english: '12', spanish: 'doce', category_id:numbers_category.id},
        {english: '13', spanish: 'trece', category_id:numbers_category.id},
        {english: '14', spanish: 'catorce', category_id:numbers_category.id},
        {english: '15', spanish: 'quince', category_id:numbers_category.id},
        {english: '16', spanish: 'dieciséis', category_id:numbers_category.id},
        {english: '17', spanish: 'diecisiete', category_id:numbers_category.id},
        {english: '18', spanish: 'dieciocho', category_id:numbers_category.id},
        {english: '19', spanish: 'diecinueve', category_id:numbers_category.id},
        {english: '20', spanish: 'veinte', category_id:numbers_category.id},
        {english: '21', spanish: 'veintiuno', category_id:numbers_category.id},
        {english: '22', spanish: 'veintidós', category_id:numbers_category.id},
        {english: '23', spanish: 'veintitrés', category_id:numbers_category.id},
        {english: '24', spanish: 'veinticuatro', category_id:numbers_category.id},
        {english: '25', spanish: 'veinticinco', category_id:numbers_category.id},
        {english: '26', spanish: 'veintiséis', category_id:numbers_category.id},
        {english: '27', spanish: 'veintisiete', category_id:numbers_category.id},
        {english: '28', spanish: 'veintiocho', category_id:numbers_category.id},
        {english: '29', spanish: 'veintinueve', category_id:numbers_category.id},
        {english: '30', spanish: 'treinta', category_id:numbers_category.id},
        {english: '31', spanish: 'treinta y uno', category_id:numbers_category.id},
        {english: '40', spanish: 'cuarenta', category_id:numbers_category.id},
        {english: '42', spanish: 'cuarenta y dos', category_id:numbers_category.id},
        {english: '50', spanish: 'cincuenta', category_id:numbers_category.id},
        {english: '53', spanish: 'cincuenta y tres', category_id:numbers_category.id},
        {english: '60', spanish: 'sesenta', category_id:numbers_category.id},
        {english: '70', spanish: 'setenta', category_id:numbers_category.id},
        {english: '80', spanish: 'ochenta', category_id:numbers_category.id},
        {english: '90', spanish: 'noventa', category_id:numbers_category.id},
        {english: '100', spanish: 'cien', category_id:numbers_category.id},
        {english: '101', spanish: 'ciento uno', category_id:numbers_category.id},
        {english: '110', spanish: 'ciento diez', category_id:numbers_category.id},
        {english: '142', spanish: 'ciento cuarenta y dos', category_id:numbers_category.id},
        {english: '200', spanish: 'doscientos', category_id:numbers_category.id},
        {english: '300', spanish: 'trescientos', category_id:numbers_category.id},
        {english: '400', spanish: 'cuatrocientos', category_id:numbers_category.id},
        {english: '500', spanish: 'quinientos', category_id:numbers_category.id},
        {english: '600', spanish: 'seiscientos', category_id:numbers_category.id},
        {english: '700', spanish: 'setecientos', category_id:numbers_category.id},
        {english: '800', spanish: 'ochocientos', category_id:numbers_category.id},
        {english: '900', spanish: 'novecientos', category_id:numbers_category.id},
        {english: '1 000', spanish: 'mil', category_id:numbers_category.id},
        {english: '1 011', spanish: 'mil once', category_id:numbers_category.id},
        {english: '1 111', spanish: 'mil ciento once', category_id:numbers_category.id},
        {english: '2 000', spanish: 'dos mil', category_id:numbers_category.id},
        {english: '3 000 003', spanish: 'tres millones tres', category_id:numbers_category.id},
